...
public class CopyOfHomePanel extends JPanel {
	...
	public CopyOfHomePanel(final DocumentView docView) {
...
//		btnSuperScript.setAction(new AbstractAction("New Page") {
//			
//			@Override
...
//		});
//		
//		btnSubScript.setAction(new AbstractAction("Fullscreen") {
//			
//			@Override
//			public void actionPerformed(ActionEvent arg0) {
//				docView.getDrowDocument().add(docView.getDrowDocument().newPage());
